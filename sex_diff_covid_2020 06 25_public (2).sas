...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model Npload = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model Sload = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
	lsmeans sex /cl; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model AntiS1IgGA450 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
	lsmeans sex /cl;
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model AntiS1IgMA450 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
	lsmeans sex /cl; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IFNa2 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
	lsmeans sex/cl; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IFNL2orIL28A = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
	lsmeans sex/cl;
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IFNy = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CCL2orMCP1 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
	lsmeans sex/cl;
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CCL5orRANTES = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
	lsmeans sex/cl; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model MCSF = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
	lsmeans sex/cl; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model TRAIL = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
	lsmeans sex/cl; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IL8orCXCL8 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IL18 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CCL4orMIP1b = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model GCSF = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CXCL10orIP10 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IL6 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model IL1Ra = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model Il1b = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model Tnum = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model Bnum = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model Tcellsoflive = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model BcellsofLive = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model TotalMonoofLive = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model ncMonoofLive = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model intMonoofLive = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr;
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model cMonoofLive = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;
...
proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CD8TofCD3 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CD4TofCD3 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CD4TCRactofCD3 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CD8TCRactofCD3 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CD8TexofCD3 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;

proc glimmix data=covid_cohortB method=rspl empirical=mbn; 
	class newid tp sex (ref = "0"); 
	model CD4TexofCD3 = sex age daysfromsxonset BMI on_tocii on_cs in_icu/s ddfm=contain cl; 
	random tp / residual type=ar(1) subject=newid v vcorr; 
run;
